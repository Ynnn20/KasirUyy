...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <nav class="sidebar sidebar-expand-lg sidebar-dark" style="background-color: <?= $color ?>;">
      <div class="container">
        <button class="sidebar-toggler" type="button" data-toggle="collapse" data-target="#sidebarSupportedContent" aria-controls="sidebarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span class="sidebar-toggler-icon"></span>
        </button>

        <div class="collapse sidebar-collapse" id="sidebarSupportedContent">
          <ul class="sidebar-nav mr-auto">
            ...
            <?php if ($level=="Admin"): ?>
              <a class="aside-link aside-item <?= $dash ?>" href="index.php?dashboard">Dashboard <span class="sr-only">(current)</span></a>
              <div class="aside-item dropdown <?= $us ?><?= $m ?>">
                <a class="aside-link dropdown-toggle" href="#" id="sidebarDropdownMenuLink" role="button" data-toggle="dropdown">Entri Referensi</a>
                <div class="dropdown-menu" aria-labelledby="sidebarDropdownMenuLink">
                  <a class="dropdown-item" href="index.php?user">Data User</a>
                  <a class="dropdown-item" href="index.php?makanan">Data Makanan</a>
                </div>
              </div>
              <!--<a class="aside-link aside-item <?= $or ?>" href="index.php?order">Entri Order <span class="sr-only">(current)</span></a>
              <a class="aside-link aside-item <?= $tran ?>" href="index.php?transaksi">Entri Transaksi <span class="sr-only">(current)</span></a>
              <a class="aside-link aside-item <?= $lap ?>" href="index.php?laporan">Laporan <span class="sr-only">(current)</span></a>-->

            <?php elseif ($level=="Waiter"): ?>
              <a class="aside-link aside-item <?= $home ?>" href="index.php">Home <span class="sr-only">(current)</span></a>
              <div class="aside-item dropdown <?= $us ?><?= $m ?>">
              </div>
              <a class="aside-link aside-item <?= $or ?>" href="index.php?makanan">Entri Makanan <span class="sr-only">(current)</span></a>
              <a class="aside-link aside-item <?= $or ?>" href="index.php?order">Entri Order <span class="sr-only">(current)</span></a>
              <a class="aside-link aside-item <?= $lap ?>" href="index.php?laporan">Laporan <span class="sr-only">(current)</span></a>
          ...
          <ul class="sidebar-nav ml-auto">
            <?php if ($_SESSION['level']==""): ?>
              <a href="../auth/index.php" class="aside-item btn btn-success">Login</a>
            <?php else: ?>
              <li class="aside-item dropdown">
                <a href="#" class="aside-link dropdown-toggle" data-toggle="dropdown" role="button"><i class="fa fa-user mr-1"></i><?= $_SESSION['level'] ?><span class="mr-1"></span></a>
            ...
            <li class="aside-item dropdown">
              <a class="aside-link" data-toggle="modal" data-target=".bd-example-modal-xl">
