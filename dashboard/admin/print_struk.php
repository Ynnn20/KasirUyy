    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-6 mx-auto" style="border: 1px solid #000;">
          <h4 class="text-center mt-2"><img src="../assets/image/kasir.png" width="40" align="middle"><span class="mt-3">Kasir Uyy</span></h4>
          <hr>
          <div class="row mt-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              Pelanggan : <?= $struk['id_user'] == 0 ? 'Tidak' : $mem['nama_user'] ?>
            </div>
          </div>
          <hr>
          <div class="row">
