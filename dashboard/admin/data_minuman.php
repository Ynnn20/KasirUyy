			...
			<table class="table table-bordered table-hover table-striped" id="tabel">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="btn-group">
								<a href="index.php?ubah_makanan=<?= $data['id_masakan'] ?>" class="btn btn-sm btn-warning btn-icon-split" style="margin-right: 5px;">
									<span class="icon text-dark-50">
										<i class="fas fa-cog"></i>
									</span>
									<span class="text">Ubah</span>
								</a>
								<a href="fungsi/hapusMakanan.php?id_masakan=<?= $data['id_masakan']; ?>" class="btn btn-sm btn-danger btn-icon-split">
